...
/**
 * Class for testing June Public Holiday in Northern Territory (Australia).
 */
class JunePublicHolidayTest extends NorthernTerritoryBaseTestCase implements HolidayTestCase
{
    /**
     * The name of the holiday.
     */
    public const HOLIDAY = 'junePublicHoliday';
