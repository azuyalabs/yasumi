...
/**
 * Class containing tests for International Workers' Day in San Marino.
 */
class InternationalWorkersDayTest extends SanMarinoBaseTestCase implements HolidayTestCase
{
    /**
