...
/**
 * Class containing tests for Independence and Unity Day in Slovenia.
 */
class IndependenceDayTest extends SloveniaBaseTestCase implements HolidayTestCase
{
    /**
    ...
    /**
     * Tests Independence Day.
     *
     * @throws \Exception
     */
    public function testIndependenceDay(): void
    {
    ...
    public function testTranslation(): void
    {
        $this->assertTranslatedHolidayName(
            ...
            [self::LOCALE => 'Dan samostojnosti in enotnosti']
        );
    }
