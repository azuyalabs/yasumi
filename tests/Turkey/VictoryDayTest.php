...
class VictoryDayTest extends TurkeyBaseTestCase implements HolidayTestCase
{
    ...
    {
        $year = static::generateRandomYear(self::CELEBRATION_YEAR);
    ...
    public function testHolidayBeforeCelebration(): void
    {
        $this->assertNotHoliday(
            self::REGION,
            self::HOLIDAY,
            static::generateRandomYear(Yasumi::YEAR_LOWER_BOUND, self::CELEBRATION_YEAR - 1)
        );
    }
    ...
    public function testTranslation(): void
    {
        $this->assertTranslatedHolidayName(
            self::REGION,
            self::HOLIDAY,
            static::generateRandomYear(self::CELEBRATION_YEAR),
    ...
    public function testHolidayTypeBeforeEstablishment(): void
    {
        $this->assertHolidayType(
            self::REGION,
            self::HOLIDAY,
            static::generateRandomYear(self::CELEBRATION_YEAR, self::ESTABLISHMENT_YEAR - 1),
