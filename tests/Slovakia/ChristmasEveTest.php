...
use DateTime,
	Yasumi\Holiday,
	Yasumi\tests\YasumiTestCaseInterface;
...
class ChristmasEveTest extends SlovakiaBaseTestCase implements YasumiTestCaseInterface
{
	 ...
	 */
	public function testChristmasEve($year, $expected)
	{
	...
	{
		$this->assertTranslatedHolidayName(self::REGION, self::HOLIDAY, $this->generateRandomYear(), [self::LOCALE => 'Štedrý deň']);
	}
