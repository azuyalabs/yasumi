...
/**
 * Class containing tests for All Saints' Day in Andorra.
 */
class AllSaintsDayTest extends AndorraBaseTestCase implements HolidayTestCase
{
    /**
