...
/**
 * Class containing tests for the Assumption of Mary in Andorra.
 */
class AssumptionOfMaryTest extends AndorraBaseTestCase implements HolidayTestCase
{
    /**
    ...
    public function testTranslation(): void
    {
        $this->assertTranslatedHolidayName(
            ...
            [self::LOCALE => "l\u{2019}Assumpció"]
        );
    }
