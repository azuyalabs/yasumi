...
/**
 * Class for testing Independence Day (28 July) in Peru.
 */
class IndependenceDayTest extends PeruBaseTestCase implements HolidayTestCase
{
    ...
    public function testHoliday(): void
    {
        ...
        $this->assertHoliday(
            ...
            self::HOLIDAY,
            $year,
            new \DateTime("{$year}-07-28", new \DateTimeZone(self::TIMEZONE))
        );
    }
