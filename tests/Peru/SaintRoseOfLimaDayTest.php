...
/**
 * Class for testing SaintRoseOfLima in Peru.
 */
class SaintRoseOfLimaDayTest extends PeruBaseTestCase implements HolidayTestCase
{
    public const HOLIDAY = 'saintRoseOfLimaDay';
    ...
    public function testHoliday(): void
    {
        ...
        $this->assertHoliday(
            ...
            self::HOLIDAY,
            $year,
            new \DateTime("{$year}-08-30", new \DateTimeZone(self::TIMEZONE))
        );
    }
    ...
    public function testTranslation(): void
    {
        $this->assertTranslatedHolidayName(
            ...
            [self::LOCALE => 'Santa Rosa de Lima']
        );
    }
