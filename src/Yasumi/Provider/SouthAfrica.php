...
class SouthAfrica extends AbstractProvider
{
    ...
    public function calculateHumanRightsDay(): void
    {
        $this->addHoliday(new Holiday(
            ...
            new DateTime($this->year . '-3-21', new DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateFamilyDay(): void
    {
        $this->addHoliday(new Holiday(
            'familyDay',
            ['en_ZA' => 'Family Day'],
            $this->calculateEaster($this->year, $this->getTimezone())->add(new DateInterval('P1D')),
            $this->locale
        ));
    }
    ...
    public function calculateFreedomDay(): void
    {
        $this->addHoliday(new Holiday(
            'freedomDay',
            ['en_ZA' => 'Freedom Day'],
            new DateTime($this->year . '-4-27', new DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateYouthDay(): void
    {
        $this->addHoliday(new Holiday(
            'youthDay',
            ['en_ZA' => 'Youth Day'],
            new DateTime($this->year . '-6-16', new DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculate2016MunicipalElectionsDay(): void
    {
        ...
        $this->addHoliday(new Holiday(
            ...
            new DateTime('2016-8-3', new DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateNationalWomensDay(): void
    {
        $this->addHoliday(new Holiday(
            ...
            new DateTime($this->year . '-8-9', new DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateHeritageDay(): void
    {
        $this->addHoliday(new Holiday(
            'heritageDay',
            ['en_ZA' => 'Heritage Day'],
            new DateTime($this->year . '-9-24', new DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateDayOfReconciliation(): void
    {
        $this->addHoliday(new Holiday(
            ...
            new DateTime($this->year . '-12-16', new DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateSubstituteDayOfGoodwill(): void
    {
        ...
        $this->addHoliday(new Holiday(
            ...
            new DateTime('2016-12-27', new DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
