...
class Ukraine extends AbstractProvider
{
    ...
    public function calculateChristmasDay(): void
    {
        $this->addHoliday(new Holiday(
            'christmasDay',
            [],
            new \DateTime("$this->year-01-07", new \DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateInternationalWomensDay(): void
    {
        $this->addHoliday(new Holiday(
            ...
            new \DateTime("$this->year-03-08", new \DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateSecondInternationalWorkersDay(): void
    {
        ...
        ], new \DateTime("$this->year-05-02", new \DateTimeZone($this->getTimezone())), $this->locale));
    }
    ...
    public function calculateVictoryDay(): void
    {
        $this->addHoliday(new Holiday(
            ...
            new \DateTime("$this->year-05-09", new \DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateConstitutionDay(): void
    {
        ...
        $this->addHoliday(new Holiday(
            ...
            new \DateTime("$this->year-06-28", new \DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateIndependenceDay(): void
    {
        ...
        $this->addHoliday(new Holiday(
            ...
            new \DateTime("$this->year-08-24", new \DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateDefenderOfUkraineDay(): void
    {
        ...
        $this->addHoliday(new Holiday(
            ...
            new \DateTime("$this->year-10-14", new \DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
