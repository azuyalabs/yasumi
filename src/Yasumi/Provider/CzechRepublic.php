...
class CzechRepublic extends AbstractProvider
{
    ...
    public function calculateSaintsCyrilAndMethodiusDay(): void
    {
        $this->addHoliday(new Holiday(
            ...
            new DateTime($this->year . '-07-5', new \DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateJanHusDay(): void
    {
        $this->addHoliday(new Holiday(
            ...
            new DateTime($this->year . '-07-6', new \DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateCzechStatehoodDay(): void
    {
        $this->addHoliday(new Holiday(
            ...
            new DateTime($this->year . '-09-28', new \DateTimeZone($this->getTimezone())),
            $this->locale
        ));
    }
    ...
    public function calculateIndependentCzechoslovakStateDay(): void
    {
        ...
        ], new DateTime($this->year . '-10-28', new \DateTimeZone($this->getTimezone())), $this->locale));
    }
